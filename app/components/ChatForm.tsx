...
export default function ChatForm({
  ...
  return (
    <div
      className={clsx(
        "rounded-full transition-all duration-500 w-full max-w-3xl",
        {
          // Gradient effects applied to wrapper instead of form
    ...
    >
      <form
        className="rounded-full bg-neutral-200/80 dark:bg-neutral-800/80 flex items-center w-full border border-transparent"
        onSubmit={onSubmit}
      >
        <input
          id="chat-input"
